...
from create_sentiments_featureset import create_features_sets_and_labels
import numpy as np
...
def neural_network_model(data):
	...
	hidden_3_layer = {'weights':tf.Variable(tf.random_normal([n_nodes_hl1,n_nodes_hl3])),'biases':tf.Variable(tf.random_normal([n_nodes_hl3]))}
